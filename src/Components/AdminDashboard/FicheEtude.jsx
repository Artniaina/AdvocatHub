      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium mb-1 block">ID Étude</label>
                  <input 
                    type="text" 
                    defaultValue="1"
              ...
              <div>
                <label className="text-sm font-medium mb-1 block">Numéro interne</label>
                <input 
                  type="text" 
          ...
          <div className="bg-white rounded-lg shadow-sm border p-4">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium mb-1 block">Forme sociale</label>
                <select className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <option>société civile</option>
                </select>
              </div>
              <div>
                <label className="text-sm font-medium mb-1 block">Numéro RCS</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="text-sm font-medium mb-1 block">Email barreau</label>
                <input 
                  type="email" 
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="px-4 py-3 text-left font-semibold">Email barreau</th>
                  <th className="px-4 py-3 text-left font-semibold">Date sermentation</th>
              ...
              <tbody>
                <tr className="bg-blue-50">
                  ...
                  <td className="px-4 py-3 border-b">maria.carrascosagil@barreau.lu</td>
