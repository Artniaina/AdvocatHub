...
const ContenuDoc = () => {
  ...
  const documents = [
    {
      ...
      type: "Contrat",
      description: "Contrat pour un employé",
    },
    {
      id: 2,
      name: "Facture 2024",
      type: "Facture",
      description: "Facture pour le mois de janvier",
    },
    {
      id: 3,
      name: "Convention de partenariat",
      type: "Contrat",
      description: "Convention avec un partenaire",
    },
    {
      id: 4,
      name: "Contrat de location",
      type: "Contrat",
      description: "Contrat pour une location immobilière",
    },
    {
      id: 5,
      name: "Rapport financier Q1",
      type: "Rapport",
    ...
    },
    {
      ...
      name: "Facture 2023",
      type: "Facture",
      description: "Facture de l'année 2023",
    },
  ];
  ...
  return (
    <div className="mainContainerDoc">
      ...
      <button className="viewButton" onClick={handleNavigate}>
        Gerer les documents
      </button>
      ...
      <div className="filterSection">
        ...
        <div className="filterButtons">
          ...
          <button
            className="filterButton"
            onClick={() => filterDocuments("Contrat")}
          >
            Contrats
          </button>
          <button
            className="filterButton"
            onClick={() => filterDocuments("Facture")}
          >
            Factures
          </button>
          <button
            className="filterButton"
            onClick={() => filterDocuments("Rapport")}
          >
            Rapports
          </button>
        </div>
